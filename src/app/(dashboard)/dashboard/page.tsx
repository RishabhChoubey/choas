    ...
    <div className="container py-12 ml-2">
      ...
      {friendsWithLastMessage.length === 0 ? (
        ...
        friendsWithLastMessage.map((friend) => (
          <div
            key={friend.id}
            className="relative bg-zinc-50 border border-zinc-200 p-3 rounded-md dark:text-white dark:bg-slate-800 mb-2 shadow-light dark:shadow-dark"
          >
              ...
              <div>
                ...
                <p className="mt-1 max-w-md">
                  <span className="text-zinc-400">
                    {friend.lastMessage?.senderId === session.id ? "You: " : ""}
                  </span>
